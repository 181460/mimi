...
// alert(str+"11111111");
    ...
    function del(pid,page) {
        ...
        if (confirm("确定删除吗")) {
          //向服务器提交请求完成删除
            window.location="${pageContext.request.contextPath}/prod/delete.action?pid="+pid + "&page=" + page + "&pname=" + pname + "&typeid=" + typeid + "&lprice=" + lprice + "&hprice=" + hprice;
        }
    }
    ...
    function one(pid, page) {
        ...
        var lprice = $("#lprice").val();
        var hprice = $("#hprice").val();
        location.href = "${pageContext.request.contextPath}/prod/one.action?pid=" + pid + "&page=" + page + "&pname=" + pname + "&typeid=" + typeid + "&lprice=" + lprice + "&hprice=" + hprice;
    }
</script>
<!--分页的AJAX实现-->
<script type="text/javascript">
